...
export class ReconnectSupervisor {
 ...
 async reconcile():Promise<void>{for(const account of await this.accounts.listEnabled())await this.serial.run(account.id,()=>this.ensure(account));}
